...
set_clock_groups -asynchronous \
                 ...
                 -group [get_clocks -include_generated_clocks cuRef] \
...
set_clock_groups -asynchronous \
                 -group [get_clocks cuStableRef] \
                 -group [get_clocks simClk70] \
                 -group [get_clocks simClk130] \
                 -group [get_clocks simClk186] \
                 -group [get_clocks cuRecClk] \
                 -group [get_clocks pllRefClk]

set_clock_groups -asynchronous \
                 -group [get_clocks cuStableRef] \
                 -group [get_clocks simClk70L] \
                 -group [get_clocks simClk130L] \
                 -group [get_clocks simClk186L] \
                 -group [get_clocks cuRecClk] \
                 -group [get_clocks pllRefClk]

set_clock_groups -asynchronous \
                 -group [get_clocks [get_clocks -of_objects [get_pins U_Base/U_PLLCLK/U_MMCM/U_MMCM/CLKOUT0] -filter {IS_GENERATED && MASTER_CLOCK == simClk186}]] \
                 -group [get_clocks [get_clocks -of_objects [get_pins {U_Base/U_Core/U_BpTx/U_BpTx/LOCREF_G.U_TimingGthCore/inst/gen_gtwizard_gthe3_top.TimingGth_fixedlat_gtwizard_gthe3_inst/gen_gtwizard_gthe3.gen_channel_container[0].gen_enabled_channel.gthe3_channel_wrapper_inst/channel_inst/gthe3_channel_gen.gen_gthe3_channel_inst[0].GTHE3_CHANNEL_PRIM_INST/RXOUTCLKPCS}]]]
