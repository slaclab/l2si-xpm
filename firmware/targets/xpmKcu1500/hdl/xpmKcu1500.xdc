...
set_clock_groups -asynchronous \
		 -group [get_clocks qsfp0RefClkP0] \
		 -group [get_clocks [list [get_clocks -of_objects [get_pins {U_HSIO/GEN_AMC_MGT[?].U_Rcvr/GEN_CTRL[?].U_GthCore/inst/gen_gtwizard_gthe3_top.gt_dslink_ss_nophase_amc0_gtwizard_gthe3_inst/gen_gtwizard_gthe3.gen_channel_container[1].gen_enabled_channel.gthe3_channel_wrapper_inst/channel_inst/gthe3_channel_gen.gen_gthe3_channel_inst[0].GTHE3_CHANNEL_PRIM_INST/RXOUTCLK}]] ]] \
		 -group [get_clocks [list [get_clocks -of_objects [get_pins {U_HSIO/GEN_AMC_MGT[?].U_Rcvr/GEN_CTRL[?].U_GthCore/inst/gen_gtwizard_gthe3_top.gt_dslink_ss_nophase_amc0_gtwizard_gthe3_inst/gen_gtwizard_gthe3.gen_channel_container[1].gen_enabled_channel.gthe3_channel_wrapper_inst/channel_inst/gthe3_channel_gen.gen_gthe3_channel_inst[0].GTHE3_CHANNEL_PRIM_INST/TXOUTCLK}]] ]]

set_clock_groups -asynchronous \
		 -group [get_clocks qsfp0RefClkP0] \
		 -group [get_clocks -of_objects [get_pins -hier -filter {NAME =~ U_HSIO/GEN_XPMASYNC.U_XpmAsync/TimingGtCoreWrapper_1/*/TXOUTCLK}]]
